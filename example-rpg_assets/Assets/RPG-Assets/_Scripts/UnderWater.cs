...
public class UnderWater : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "Body")
        {
            other.gameObject.GetComponentInParent<PlayerController>().ChangeSwimmingMode(true);
        }
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.tag == "Body")
        {
            other.gameObject.GetComponentInParent<PlayerController>().ChangeSwimmingMode(false);
        }
    }
}
